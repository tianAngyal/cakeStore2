  ...
  store.allItems.forEach((item) => {
    const markUp = `
                          ...
                          <div class="desert-card" id="${item.id}">
                              <img src="${item.images.desktop}" class="desert-card_image ${item.quantity ? "border" : ""}" />
                              <div class="desert-card_add-to-image ${item.quantity ? "hidden" : ""}">
                              ...
                              <div class="desert-card_counter-container ${item.quantity ? "" : "hidden"}">
                              ...
                              <div class="desert-card_description">
                                  <ul class="desert-card_description_list">
                                      ...
                                      <li class="desert-card_description_list_item">
                                          <p class="price">${euro(item.price) + euro(item.price).s.symbol}</p>
                                      </li>
                                  </ul>
                              </div>
                          </div>
